...
const CustomTooltip = ({
  ...
  active?: boolean;
  payload?: Array<{
    payload: { name: string; clientes?: number; agentes?: number; value?: number };
  }>;
}) => {
    ...
    return (
      <div className="bg-white p-3 border border-gray-300 rounded shadow-lg">
        ...
        {payload[0].payload.agentes && (
          <p className="text-sm">
            Agentes: {payload[0].payload.agentes.toLocaleString()}
          </p>
        )}
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">
          Dashboard de Segmentación 2025
        </h1>
        <p className="text-gray-600 mb-6">
          19 Clientes | 9,342 Agentes Totales
        </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="lg:col-span-2 bg-blue-50 border-l-4 border-blue-600 p-6 rounded-lg">
              ...
              <p className="text-blue-800">
                El 88% de los agentes (8,350) están concentrados en solo 3
                clientes Enterprise. Esto representa una oportunidad de
                expansión en los segmentos Mid-Market y Growth con mayor margen.
              </p>
            </div>
          </div>
        )}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-orange-50 border-l-4 border-orange-600 p-6 rounded-lg">
              ...
              <ul className="text-orange-800 space-y-2">
                <li>
                  • <strong>Mega/Grande:</strong> Enfoque en retención y
                  upselling
                </li>
                <li>
                  • <strong>Mediano:</strong> Mayor potencial de crecimiento
                </li>
                <li>
                  • <strong>Pequeño/Micro:</strong> Automatización rápida con IA
                </li>
              </ul>
            </div>
          </div>
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-red-500 pl-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Atención inmediata - Alto volumen de agentes
                  </p>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-purple-50 border-l-4 border-purple-600 p-6 rounded-lg">
              ...
              <p className="text-purple-800 mb-3">
                Los clientes con dolor de <strong>Omnicanalidad</strong> (6
                clientes) son candidatos naturales para soluciones de{" "}
                <strong>QA + Speech Analytics</strong>.
              </p>
              ...
              <div className="space-y-3">
                <div className="p-3 bg-blue-50 rounded">
                  ...
                  <p className="text-sm text-blue-700">
                    Mayor demanda - Solución flagship
                  </p>
                </div>
                <div className="p-3 bg-purple-50 rounded">
                  <p className="font-semibold text-purple-900">
                    QA + Speech Analytics (4)
                  </p>
                  <p className="text-sm text-purple-700">
                    Alto valor - Diferenciador competitivo
                  </p>
                </div>
                <div className="p-3 bg-green-50 rounded">
                  <p className="font-semibold text-green-900">
                    Bots/Agentes Virtuales (4)
                  </p>
                  <p className="text-sm text-green-700">
                    Innovación - ROI rápido
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-green-50 border-l-4 border-green-600 p-6 rounded-lg">
              ...
              <p className="text-green-800 mb-3">
                <strong>10 clientes (53%)</strong> con potencial ALTO de
                crecimiento representan la mejor oportunidad de expansión para
                2025.
              </p>
              <p className="text-green-800">
                Ningún cliente tiene potencial bajo, lo que indica una cartera
                saludable y con alta probabilidad de éxito.
              </p>
            </div>
          </div>
        )}
